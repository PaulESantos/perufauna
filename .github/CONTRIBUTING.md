# Contributing to perufauna

This outlines how to propose a change to perufauna.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("PaulESantos/perufauna", fork = TRUE)`.
...
Please note that the perufauna project is released with a
