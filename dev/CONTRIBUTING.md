...
This outlines how to propose a change to perufauna. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/perufauna", fork = TRUE)`.
...
Please note that the perufauna project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/perufauna/dev/CODE_OF_CONDUCT.md).
